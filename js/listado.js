...
Listado.prototype.buscarRestaurante = function(id) {
  let restoEncontrado = this.restaurantes.find(function(element) {
    return element.id === id;
  });

  if (restoEncontrado !== undefined) {
...
Listado.prototype.obtenerCiudades = function() {
  ...
  var listaCiudades = this.restaurantes.map(function(i) {
    return i.ubicacion;
  });
  //Se crea un nuevo array donde se van a agregar las ciudades pero sin repetirse
  return this.eliminarRepetidos(listaCiudades);
};
...
Listado.prototype.obtenerRubros = function() {
  var listaRubros = this.restaurantes.map(function(i) {
    return i.rubro;
  });
  return this.eliminarRepetidos(listaRubros);
};
...
Listado.prototype.obtenerHorarios = function() {
  ...
  var arrayHorarios = this.restaurantes.map(function(i) {
    return i.horarios;
  });
  //En este arreglo vamos a poner todos los horarios, uno por uno
  var listaHorarios = [];
  arrayHorarios.forEach(function(a) {
  ...
  return this.eliminarRepetidos(listaHorarios);
};
...
Listado.prototype.eliminarRepetidos = function(array) {
  var listaSinRepeat = array.filter(function(elem, index, self) {
    return index === self.indexOf(elem);
  });

  return listaSinRepeat.sort();
};
